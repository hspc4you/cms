package com.jsz.peini.util.emchat.comm;
...
public interface Constants {
	...
	// DEFAULT_PASSWORD
	public static String DEFAULT_PASSWORD = PropertiesUtils.getProperties().getProperty("DEFAULT_PASSWORD");
	// APP_ADMIN_NAME1
    public static String APP_ADMIN_NAME1 = PropertiesUtils.getProperties().getProperty("APP_ADMIN_NAME1");
    // ORG_ADMIN_PASSWORD1
    public static String ORG_ADMIN_PASSWORD1 = PropertiesUtils.getProperties().getProperty("ORG_ADMIN_PASSWORD1");
}
