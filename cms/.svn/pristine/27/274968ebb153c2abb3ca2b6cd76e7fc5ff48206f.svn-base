package com.jsz.peini.util.emchat.utils;
...
import com.jsz.peini.util.emchat.vo.Token;
...
public class HTTPClientUtils {
	 ...
	 * @return
	 */
	public static JSONObject sendHTTPRequest(URL url, Credential credentail, Object dataBody, String method) {
	 ...
	 * @return
	 */
	public static JSONObject uploadFile(URL url, File file, Credential credentail, List<NameValuePair> headers)
